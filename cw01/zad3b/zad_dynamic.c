...
int main(int argc, char **argv){
    ...
    */
    ...
    void (*destroy)() = (void (*)()) dlsym(lib, "destroy");
    void (*destroy_pairs)() = (void (*)()) dlsym(lib, "destroy_pairs");

    struct ArrayPairs* (*create_pairs)() = (struct ArrayPairs* (*)()) dlsym(lib, "create_pairs");
    struct Table* (*generate)() = (struct Table* (*)()) dlsym(lib, "generate");

    //size_t (*blocks_amount)() = (size_t (*)()) dlsym(lib, "blocks_amount");
    //size_t (*operations_amount)() = (size_t (*)()) dlsym(lib, "operations_amount");

    void (*erase_block)() = (void (*)()) dlsym(lib, "erase_block");
    void (*erase_operation)() = (void (*)()) dlsym(lib, "erase_operation");
